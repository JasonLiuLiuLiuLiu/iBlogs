<template>
  <div>
    ...
    <div class="lists-navigator clearfix" v-else>
      <ol class="page-navigator">
        <li class="prev" v-if="data.pageNum>1"><a :href="'/'+displayType+'/'+encodeURIComponent(displayMeta)+'/'+(data.pageNum-1)">←</a></li>
        <li :class="index==data.pageNum?'current':''" v-for="index in data.totalPage"><a :href="'/'+displayType+'/'+encodeURIComponent(displayMeta)+'/'+index">{{index}}</a>
        </li>
        <li class="next" v-if="data.pageNum<data.totalPage"><a :href="'/'+displayType+'/'+encodeURIComponent(displayMeta)+'/'+(data.pageNum+1)">→</a></li>
      </ol>
    </div>
  </div>
</template>
