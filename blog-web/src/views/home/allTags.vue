            ...
            <nav class="TopstoryTabs Topstory-tabs">
                        ...
                        <span class="TagsHeader">
                            <svg class="Zi Zi--Live" fill="currentColor" style="color: rgb(0, 132, 255);"
                                 viewBox="0 0 425.7 425.7" width="24" height="24">
                                <g><g><path
                                  d="M167.538,231.652c-2.56-0.512-5.632,1.024-6.144,4.096l-24.064,117.76c-0.512,2.56,1.024,5.632,4.096,6.144c0.512,0,0.512,0,1.024,0c2.56,0,4.608-1.536,5.12-4.096l24.064-117.76C172.146,235.236,170.61,232.164,167.538,231.652z"/></g></g>
                                <g><g><path
                                  d="M202.354,238.82c-2.56-0.512-5.632,1.024-6.144,4.096l-24.064,117.76c-0.512,2.56,1.024,5.632,4.096,6.144c0.512,0,0.512,0,1.024,0c2.56,0,4.608-1.536,5.12-4.096l24.064-117.76C206.962,241.892,204.914,239.332,202.354,238.82z"/></g></g>
                                <g><g><path
                                  d="M236.658,245.988c-2.56-0.512-5.632,1.024-6.144,4.096l-24.064,117.76c-0.512,2.56,1.024,5.632,4.096,6.144c0.512,0,0.512,0,1.024,0c2.56,0,4.608-1.536,5.12-4.096l24.064-117.76C241.266,249.06,239.218,246.5,236.658,245.988z"/></g></g>
                                <g><g><path
          ...
          <div id="TopstoryContent" class="Topstory-content">
            <div class="ListShortcut">
              <div class="Topstory-recommend">
                <div class="">
                  <div class="QuestionHeader-topics Card TopstoryItem TopstoryItem-isRecommend">

                    <div class="Tag QuestionTopic" v-for="tag in list">
                                            <span class="Tag-content">
                                                <a class="TopicLink" :href="'/tag/'+tag.name">
                                                    <div class="Popover">
                                                        <div id="Popover7-toggle" aria-haspopup="true"
                                                             aria-expanded="false" aria-owns="Popover7-content"># {{tag.name+'('+tag.count+')'}}</div>
                                                    </div>
                                                </a>
                                            </span>
                    </div>
